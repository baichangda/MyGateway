...
//            final long l3 = bitBuf2.read_log(9);
            final LogRes res1 = bitBuf2.read_log(3);
            final LogRes res2 = bitBuf2.read_log(3);
            final LogRes res3 = bitBuf2.read_log(9);
            res1.print();
            res2.print();
            res3.print();
...
//            System.out.println(l3);
    ...
    public static class LogRes {
        ...
        public LogRes(int byteLen, int bitStart, int bitEnd) {
    ...
    public LogRes read_log(int bit) {
        if (bitOffset == 0) {
            b = byteBuf.readByte();
        }
        ...
        logRes.val = (c >>> right) & ((0x01L << bit) - 1);
