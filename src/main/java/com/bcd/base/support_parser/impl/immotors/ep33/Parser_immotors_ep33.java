...
public class Parser_immotors_ep33 {

    static Logger logger= LoggerFactory.getLogger(Parser_immotors_ep33.class);

    public Parser_immotors_ep33() {
    }
...
//        Parser.withDefaultLogCollector_deParse();
        ...
        int num = 1000000000;
        PerformanceUtil.testMultiThreadPerformance(CompressUtil.unGzip(Base64.getDecoder().decode(base64),8192), Packet.class, threadNum, num, true);
    }
}
